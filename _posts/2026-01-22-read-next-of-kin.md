...
This names a specific person - any person you choose - who has legal authority to make medical decisions if you can't. It overrides the next-of-kin default.
Getting this done requires finding the correct form for your state or country (they vary, which is genuinely irritating), filling it out correctly, and having it witnessed and often notarized. That means finding a notary - your bank usually has one, some libraries do too - and physically going there with the right ID. It's not complicated but it is an errand most people put off indefinitely.
